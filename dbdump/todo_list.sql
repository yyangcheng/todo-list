...
CREATE TABLE `list` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT '待辦事項板ID',
  `title` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '待辦事項板名稱',
